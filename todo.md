...
## 🔧 CORREÇÕES CRÍTICAS v1.0.6 (MÁXIMA COMPATIBILIDADE iOS/Android)

- [x] Remover aba Admin da barra inferior (href: null)
- [x] Corrigir Objetivos do Ciclo (Android + iOS compatível com TextInput)
- [x] Criar aba Agendamento Futuro simples (data/hora + observações editáveis)
- [x] Remover aba Settings (href: null, causava erro na assinatura)
