...
/**
 * PWA-Only Authentication Router
 * This router is ONLY for the PWA web app and does NOT affect iOS/Android apps
 * iOS/Android have their own separate authentication flow
 */
export const pwaAuthRouter = router({
  /**
   * Register a new PWA user (not approved by default)
